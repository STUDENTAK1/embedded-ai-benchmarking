...
static inline bool isTarget(uint16_t p) {
  ...
  // Cyan:  R=41-57,  G=239,     B=247-255  → B>220 AND G>180 AND R<80
  // Green: R=0-49,  G=195-239, B=148-206  → fails B>220
  // Red:   R=66-115,G=32-77,   B=41-82    → fails G>180 and B>220
  // Skin:  R=82-107,G=97-134,  B=99-132   → fails G>180 and B>220
  return (B > 220) && (G > 180) && (R < 80);
}
